  ...
  if (authLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-black text-white">
        <div className="animate-pulse text-terracotta-400">
          Loading Application...
        ...
        <div className="fixed bottom-24 right-6 z-[99999] flex flex-col items-end gap-3">
          {showFabMenu && (
            ...
            <button 
              ...
              className={`p-5 rounded-full shadow-[0_0_50px_rgba(124,58,237,0.6)] transition-all duration-300 border border-white/10 ${showFabMenu ? 'bg-zinc-800 text-zinc-400 rotate-45' : 'bg-terracotta-600 text-white hover:bg-terracotta-500 hover:scale-110 active:scale-90'}`}
