    ...
    return (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl border border-slate-800 overflow-hidden animate-fade-in">
                <div className="bg-terracotta-600 p-4 flex justify-between items-center text-white shadow-lg shadow-terracotta-900/20">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <input
                                ...
                                className="w-full p-3 bg-slate-950 border border-slate-700 rounded-xl text-white outline-none focus:border-terracotta-500 focus:ring-1 focus:ring-terracotta-500 transition-all placeholder:text-slate-600"
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <button
                                ...
                                className={`p-3 rounded-xl border text-sm font-medium transition-all ${role === 'ADMIN'
                                    ? 'bg-terracotta-600 border-terracotta-500 text-white shadow-lg shadow-terracotta-900/20'
                                    : 'bg-slate-950 border-slate-800 text-slate-500 hover:bg-slate-900 hover:text-slate-300'
                                    }`}
                                disabled={isLoading}
                            >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full p-3 bg-slate-950 border border-slate-700 rounded-xl text-white outline-none focus:border-terracotta-500 focus:ring-1 focus:ring-terracotta-500 transition-all appearance-none cursor-pointer"
                                disabled={isLoading}
                            >
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full bg-terracotta-600 hover:bg-terracotta-500 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-terracotta-900/20 transition-all flex items-center justify-center gap-2 transform active:scale-[0.98] ${isLoading ? 'opacity-70 cursor-wait' : ''}`}
                    >
                        <UserPlus size={18} />
