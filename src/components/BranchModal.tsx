            ...
            <div className="bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl border border-slate-800 animate-zoom-in my-8">
                <div className="p-4 border-b border-slate-800 flex justify-between items-center">
                    <h3 className="text-white font-bold flex items-center gap-2">
                        <Store size={18} className="text-terracotta-400" />
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-3 bg-slate-950 border border-slate-700 rounded-xl text-white outline-none focus:border-terracotta-500 transition-all"
                    ...
                    <div className="pt-2 border-t border-slate-800/50">
                        <label className="block text-sm font-medium text-slate-400 mb-2 flex justify-between">
                            ...
                            {urlInput && (
                                <button type="button" onClick={handleTestLink} className="text-xs text-terracotta-400 hover:text-terracotta-300 flex items-center gap-1">
                        ...
                        <input
                            ...
                            className="w-full p-3 bg-slate-950 border border-slate-700 rounded-xl text-white outline-none focus:border-terracotta-500 transition-all text-sm"
                    ...
                    <button type="submit" className="w-full mt-6 bg-terracotta-600 hover:bg-terracotta-500 text-white font-bold py-3 rounded-xl transition-all">
                        บันทึก
                    </button>
                </form>
            </div>
