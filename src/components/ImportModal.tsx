                ...
                <div className="p-4 overflow-y-auto flex-1 space-y-4">
                                ...
                                {branches.filter(b => b.id !== 'HQ').map(b => (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-400 group-hover:text-terracotta-400 transition-colors">
                                                <Store size={20} />
                                            </div>
                                            <div>
                        ...
                        <div className="bg-zinc-800/30 border border-zinc-700/50 rounded-xl p-4 mb-4">
                            <div className="flex justify-between items-center mb-3">
                                <div className="flex items-center gap-2">
                                    <div className="w-8 h-8 rounded-lg bg-terracotta-600/20 flex items-center justify-center text-terracotta-400">
                                        <LinkIcon size={16} />
                                    </div>
                                    <div>
                            ...
                            {(!branches.find(b => b.id === localBranchId)?.googleSheetsUrl || editingUrlBranchId === localBranchId) ? (
                                    ...
                                    {isAdmin ? (
                                        <div className="flex gap-2">
                                            <input 
                                                ...
                                                className="flex-1 bg-black border border-zinc-700 rounded-lg px-3 py-2 text-xs text-white outline-none focus:border-terracotta-500 transition-all"
                                ...
                                <div className="flex items-center gap-2 bg-black/30 p-2 rounded-lg border border-zinc-800">
                                    ...
                                    <button 
                                        ...
                                        className="text-[10px] bg-terracotta-600 hover:bg-terracotta-500 text-white px-3 py-1.5 rounded-md font-bold transition-all whitespace-nowrap"
                                    >
                                        ดึงข้อมูลใหม่
                                    </button>
                                </div>
                    ...
                    {phase === 'loading' && (
                        <div className="flex flex-col items-center justify-center py-12 gap-4">
                            <Loader size={32} className="text-terracotta-400 animate-spin" />
                    ...
                    {phase === 'error' && (
                        <div className="flex flex-col items-center justify-center py-8 gap-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    onClick={() => loadData(localBranchId)}
                                    className="px-4 py-2 bg-terracotta-600 hover:bg-terracotta-500 text-white rounded-xl text-sm font-bold"
                                >
                                    ลองใหม่
                                </button>
                            </div>
                    ...
                    {phase === 'preview' && importData && (
                        <>
                            ...
                            {/* Duplicate Info */}
                            <div className="bg-terracotta-500/5 border border-terracotta-500/20 rounded-xl p-3 space-y-2">
                                <div className="flex items-center gap-2 mb-1">
                                    <CheckCircle2 size={16} className="text-terracotta-400" />
                                    <span className="text-sm font-bold text-terracotta-400">สรุปการซิงค์ข้อมูล</span>
                                </div>
                                ...
                                <p className="text-[10px] text-zinc-500 pt-2 border-t border-terracotta-500/10 mt-2">
