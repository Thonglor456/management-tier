...
export const LoginScreen: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 font-sans relative overflow-hidden selection:bg-terracotta-500/30 selection:text-terracotta-200">
            {/* Animated Background Blobs */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-terracotta-800/20 rounded-full blur-[120px] animate-pulse-slow"></div>
            ...
            <div className="w-full max-w-[420px] bg-white/[0.03] backdrop-blur-2xl border border-white/[0.05] rounded-3xl shadow-2xl p-8 sm:p-10 relative z-10 animate-fade-in-up">
                ...
                <div className="text-center mb-10">
                    <div className="w-24 h-24 mx-auto mb-6 relative group">
                        <div className="absolute inset-0 bg-terracotta-600/20 rounded-full blur-xl group-hover:bg-terracotta-600/30 transition-all duration-500"></div>
                        <img
                            src={logo}
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <User size={18} className="text-white/30 group-focus-within:text-terracotta-400 transition-colors duration-300" />
                            </div>
                            <input
                                type="text"
                                required
                                ...
                                className="w-full pl-11 pr-4 py-3.5 bg-white/[0.03] border border-white/[0.08] hover:border-white/[0.15] rounded-2xl text-white placeholder:text-white/20 outline-none focus:border-terracotta-500/50 focus:bg-white/[0.05] focus:ring-4 focus:ring-terracotta-500/10 transition-all duration-300"
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <Lock size={18} className="text-white/30 group-focus-within:text-terracotta-400 transition-colors duration-300" />
                            </div>
                            <input
                                type="password"
                                required
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full bg-terracotta-600 hover:bg-terracotta-500 text-white font-bold py-4 rounded-2xl shadow-lg shadow-terracotta-900/30 hover:shadow-terracotta-600/40 transition-all duration-300 transform hover:-translate-y-0.5 mt-2 flex items-center justify-center gap-2 group ${isLoading ? 'opacity-70 cursor-wait' : ''}`}
                    >
                        {isLoading ? (
