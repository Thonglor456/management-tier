            ...
            <div className="bg-zinc-900 w-full max-w-2xl rounded-2xl shadow-2xl border border-zinc-800 overflow-hidden animate-slide-up flex flex-col max-h-[90vh]">
                <div className="p-4 flex justify-between items-center bg-zinc-800 border-b border-zinc-700">
                    <h3 className="text-lg font-bold text-white flex items-center gap-2">
                        <Calculator className="text-terracotta-400" /> ตรวจสอบยอดเงิน (Reconciliation)
                    </h3>
                ...
                <div className="p-6 overflow-y-auto">
                    <div className="space-y-4">
                        ...
                        {ACCOUNTS.map(acc => {
                            ...
                            return (
                                <div key={acc.id} className="grid grid-cols-12 gap-4 items-center bg-black/40 p-3 rounded-xl border border-zinc-800 hover:border-terracotta-500/30 transition-colors">
                                    <div className="col-span-4 flex items-center gap-3">
                                        <div className="p-2 bg-terracotta-500/10 rounded-lg text-terracotta-400">
                                            {acc.icon}
                                        </div>
                                    ...
                                    <div className="col-span-3">
                                        <input
                                            ...
                                            className="w-full bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-1.5 text-right text-white outline-none focus:ring-2 focus:ring-terracotta-500 transition-all font-bold placeholder-zinc-700"
                                        />
                                    </div>
                    ...
                    <div className="mt-8 bg-terracotta-500/10 border border-terracotta-500/20 p-4 rounded-xl">
                        <h4 className="text-terracotta-300 font-bold mb-2 text-sm">💡 คำแนะนำ</h4>
                    ...
                    <div className="mt-6 flex justify-between">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={isSaving || isAdjusting}
                            className="flex items-center gap-2 bg-terracotta-600 hover:bg-terracotta-500 text-white px-6 py-2 rounded-xl font-bold transition-all shadow-lg shadow-terracotta-900/20 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            <Save size={18} />
