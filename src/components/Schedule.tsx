            ...
            days.push(
                <button
                    ...
                    className={`h-10 sm:h-14 rounded-lg flex flex-col items-center justify-center relative transition-all border ${isSelected
                        ? 'bg-terracotta-600 border-terracotta-500 text-white shadow-lg shadow-terracotta-900/40'
                        : 'bg-zinc-800/50 border-zinc-800 text-zinc-400 hover:bg-zinc-800'
                        } ${isToday ? 'ring-2 ring-terracotta-400 ring-offset-2 ring-offset-zinc-950' : ''}`}
                >
            ...
            <div className="flex justify-between items-center bg-zinc-900/50 p-4 rounded-xl border border-zinc-800">
                <div>
                    <h2 className="text-xl font-bold text-white flex items-center gap-2">
                        <CalendarIcon className="text-terracotta-400" /> ตารางงาน
                    </h2>
                ...
                <>
                    ...
                    <div className="pt-4 border-t border-zinc-800/50">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                            ...
                            <Card className="p-4 bg-zinc-900/40 border-zinc-800/50">
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="p-2 bg-terracotta-500/10 rounded-lg text-terracotta-400"><Banknote size={18} /></div>
                                    ...
                                    <Card key={staff.id} className="p-5 bg-zinc-900/60 border-zinc-800 transition-all hover:bg-zinc-800/40">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-12 h-12 rounded-full bg-terracotta-500/20 flex items-center justify-center text-xl font-bold text-terracotta-400">
                                                    {staff.name.charAt(0)}
                                                </div>
                                                <div>
                    ...
                    <div className="space-y-4 pt-4 border-t border-zinc-800/50">
                        <div className="flex justify-between items-center px-1">
                            ...
                            <button
                                ...
                                className="bg-terracotta-600 hover:bg-terracotta-500 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors shadow-lg shadow-terracotta-900/20"
                            >
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-terracotta-400 font-bold text-sm">฿{shift.wage.toLocaleString()}/วัน</span>
                                                </div>
                                        ...
                                        <div className="flex items-center justify-between sm:justify-end gap-4 border-t sm:border-t-0 border-zinc-800 pt-3 sm:pt-0">
                                            ...
                                            <div className="flex items-center gap-1">
                                                <button
                                                    ...
                                                    className="p-2 text-zinc-500 hover:text-terracotta-400 transition-colors"
                                                >
                                                    <Edit2 size={16} />
                                                </button>
                                                <button
                                ...
                                {shiftsOnSelectedDate.some(s => s.status === 'PRESENT') && (
                                    <div className="mt-6 p-5 bg-zinc-900/50 rounded-2xl border border-zinc-800 space-y-3">
                                        <div className="flex items-center gap-2 mb-2">
                                            <LayoutList size={16} className="text-terracotta-400" />
                    ...
                    <div className="bg-zinc-900/30 rounded-xl border border-zinc-800 overflow-hidden">
                        ...
                        <div className="p-4 border-b border-zinc-800 flex justify-between items-center bg-zinc-900/50">
                            ...
                            <button
                                type="button"
                                onClick={() => setShowAddModal(true)}
                                className="bg-terracotta-600 hover:bg-terracotta-500 text-white px-3 py-1.5 rounded-lg text-xs font-medium flex items-center gap-2 transition-colors"
                            >
                                <Plus size={14} /> เพิ่ม
                            </button>
                        </div>
                                                ...
                                                <td className="px-4 py-3 text-right">
                                                    <div className="flex justify-end gap-1">
                                                        <button
                                                            ...
                                                            className="p-1.5 text-zinc-500 hover:text-terracotta-400 hover:bg-terracotta-500/10 rounded-lg transition-colors"
                                                        >
                                                            <Edit2 size={16} />
                                                        </button>
                                                        <button
                    ...
                    <div className="bg-zinc-900 w-full max-w-md rounded-2xl border border-zinc-800 shadow-2xl overflow-hidden">
                        ...
                        <div className="p-4 space-y-4">
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-2">
                                    <select
                                        ...
                                        className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-terracotta-500 outline-none appearance-none"
                                    >
                            ...
                            {(!selectedStaffId || selectedStaffId === 'new') && (
                                <div className="animate-fade-in">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-terracotta-500 outline-none"
                                    />
                                </div>
                            )}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="300"
                                        className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-terracotta-500 outline-none font-bold text-emerald-400"
                                    />
                                </div>
                                <div>
                            ...
                            <button
                                ...
                                className="w-full bg-terracotta-600 hover:bg-terracotta-500 text-white font-bold py-4 rounded-xl mt-4 transition-all shadow-lg shadow-terracotta-900/40 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
            ...
            {showHistoryModal.show && showHistoryModal.staff && (
                <div className="fixed inset-0 bg-black/80 z-[55] flex items-center justify-center p-4">
                    <div className="bg-zinc-900 w-full max-w-md rounded-2xl border border-zinc-800 shadow-2xl overflow-hidden h-[500px] flex flex-col">
                        <div className="p-4 border-b border-zinc-800 flex justify-between items-center bg-zinc-900/50">
                            <h3 className="font-bold text-white flex items-center gap-2"><History size={18} className="text-terracotta-400" /> ประวัติการเบิก: {showHistoryModal.staff.name}</h3>
