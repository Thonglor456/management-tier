                ...
                <div className="p-6 space-y-6">
                            ...
                            {ACCOUNTS.map(acc => (
                                <button
                                    ...
                                    className={`flex items-center justify-between p-3 rounded-xl border transition-all ${selectedAccount === acc.id
                                        ? 'bg-terracotta-600/20 border-terracotta-500 text-white'
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-black border border-zinc-700 rounded-xl px-4 py-3 text-2xl font-bold text-white outline-none focus:ring-2 focus:ring-terracotta-500 text-center placeholder-zinc-800"
                            autoFocus
                        />
