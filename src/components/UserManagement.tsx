            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-white flex items-center gap-3">
                        <span className="bg-terracotta-500/20 p-2 rounded-lg text-terracotta-400"><Shield size={24} /></span>
                        จัดการพนักงาน
                    </h2>
                        ...
                        <tbody className="divide-y divide-slate-800">
                            {users.map(user => (
                                <tr key={user.id} className="hover:bg-slate-800/30 transition-colors group">
                                    ...
                                    <td className="p-4">
                                        {user.role === 'ADMIN' ? (
                                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-terracotta-500/10 text-terracotta-400 border border-terracotta-500/20">
                                    ...
                                    <td className="p-4 text-right pr-6">
                                        <button
                                            ...
                                            className="p-2 rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-terracotta-600 transition-all shadow-sm"
                                            title="แก้ไขข้อมูล"
                                        >
                                            <Edit2 size={16} />
                                        </button>
